...
- `find <term>` — count exact (word-boundary, case-insensitive) occurrences of a term across indexed documents, reported per document with page numbers.
