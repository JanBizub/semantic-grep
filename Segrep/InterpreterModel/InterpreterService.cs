...
public sealed class InterpreterService(IChatClient chatClient)
{
    private const string InterpretSystemPrompt =
        ...
        "\"query\": the prompt rewritten as a focused, information-dense search query that surfaces relevant document passages.";
    ...
    private const string CorpusAnswerSystemPrompt =
        ...
        "is addressed; do not skip any. Use only the provided excerpts and cite as [source: <filename> #<chunk_index>]. " +
